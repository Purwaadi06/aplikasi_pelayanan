...
<div class="flex min-h-screen bg-gray-100">
    ...
    <main class="flex-1 p-6">
        ...
        <div class="bg-white p-6 rounded shadow">
            <img src="{{ asset('img/logo-desa.png') }}" alt="Logo Desa" class="w-32 mb-4">
            <h2 class="text-xl font-bold mb-2">Halo, Administrator</h2>
            <p>Selamat datang di <span class="text-blue-600">Web Aplikasi Pelayanan Surat Administrasi Desa Online.</span></p>
